...
- Root requirements document: `AI_Office_requirements_review_v0.23.md`
- Current Gate handoff: `AIOffice_Gate2_Codex_handoff.md`
- Prior Gate 1 handoff: `AIOffice_Gate1_Codex_handoff.md`
